...
#+attr_html: :height 500px
[[./materialer/Opgave_HR-diagrammer_og_stjernehobe.pdf][file:./img/stjernehobe_opgave_forside.png]]
...
#+reveal_html: <div>
- I kan downloade opgaven ved at trykke på billedet til venstre.
- Hent de relevante datafiler (I kan nok bedst lide excel-filen).
  - [[./materialer/HR-diagrammer_for_stjernehobe.xlsx][HR-diagrammer_for_stjernehobe.xlsx]]
  - [[./materialer/Plejaderne.csv][Plejaderne.csv]]
  - [[./materialer/47_tuc.csv][47_tuc.csv]]
#+reveal_html: </div>
#+reveal_html: </div>
